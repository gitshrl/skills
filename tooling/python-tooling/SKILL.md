---
name: python-tooling
description: Manage Python projects with uv and ruff — dependencies, lockfiles, scripts, interpreter versions, linting, and formatting. Use for any Python dependency work, venv creation, script execution, or lint/format run.
---
